<div class="content row col-md-12">
    <div class="row home col-md-12">
        <div class="col-md-12 row homeall">
            ...
            <div class="homealllist col-md-4">
                <div class="homelisttag hometag">
                    <h2>Usługi pielęgniarskie</h2>
                </div>
                <div class="homelist">
                    <ul>
                        <li>Wlew z witaminy C</li>
                        <li>Ozonoterapia</li>
                        <li>Zastrzyki</li>
                        <li>Pobieranie krwi</li>
                        <li>Kroplówki</li>
                        <li>Zdejmowanie szwów</li>
                        <li>Sondy żołądkowe</li>
                        <li>Cewnikowanie</li>
                        <li>Leczenie ran</li>
                        <li>Zakładanie wenflonu</li>
                        <li>Opieka domowa</li>
                        <li>Pielęgnacja stomii</li>
                        <li>Lewatywa</li>
                        <li>Stawianie baniek</li>
        ...
        <div class="col-md-12 " id="footerhome">
